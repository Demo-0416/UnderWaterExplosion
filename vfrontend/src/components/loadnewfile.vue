    ...
    dataZoom: [
      {
        ...
        dataBackground: {//数据阴影的样式。
                    ...
                    areaStyle: {color: '#b3dd98'},//阴影的填充样式
                },
        ...
        moveHandleStyle: {  
            ...
            // 其他可能的样式属性，如阴影（shadowBlur, shadowColor, shadowOffsetX, shadowOffsetY）等  
            // 注意：不是所有样式属性都支持，具体取决于ECharts的版本和内部实现  
        },  
        // sliderStyle: {  
