"""
Django settings for UnderWaterExplosion project.
...
SECRET_KEY = 'django-insecure-4^d2je_2!mj5uhqocshan#+bxbf-tk7t4b#$2&pc@7*lkj3l+x'
...
ROOT_URLCONF = 'UnderWaterExplosion.urls'
